...
\subsubsection*{Parámetros}
\[
P=\{1,2\}\ (\text{plantas}),\qquad
J=\{A,B\}\ (\text{productos}),\qquad
R=\{\text{mano de obra},\text{materia prima}\},
\]
\[
u_j=\text{utilidad por unidad del producto } j,\quad
f_p=\text{costo fijo de apertura de la planta } p,\quad
K_p=\text{capacidad de la planta } p,
\]
\[
a_{rj}=\text{consumo del recurso } r \text{ por unidad de } j,\quad
\bar{R}_r=\text{disponibilidad del recurso } r,\quad
