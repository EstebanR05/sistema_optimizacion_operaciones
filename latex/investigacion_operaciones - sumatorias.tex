...
\begin{titlepage}
	...
	{\large UNICOMFACAUCA}\\[0.3cm]
	{\large Fundación Universitaria de Popayán}\\[2.2cm]
...
Por otra parte, el ejercicio 4 fue reportado como inviable en ambas herramientas. En este caso, la incompatibilidad entre las demandas mínimas y la disponibilidad de materia prima impide alcanzar una solución factible. En este tipo de escenarios no es válido interpretar valores objetivo o realizar un análisis de sensibilidad formal, ya que el problema radica en la formulación y no en el lenguaje utilizado.
